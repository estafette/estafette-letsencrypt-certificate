govendor init
govendor fetch github.com/ericchiang/k8s@v0.2.0
...
govendor fetch github.com/xenolf/lego/acme@v1.0.1
govendor fetch github.com/xenolf/lego/providers/dns/cloudflare@v1.0.1
